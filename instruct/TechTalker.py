...
- <WWW><url>https://...</url><jsExecute>document.querySelectorAll('a').length</jsExecute></WWW> — Fetch web pages. Your primary research tool. Params: <url>, [<text>], [<links>], [<js>], [<jsExecute>] — jsExecute extracts specific data, returns ONLY the result
