...
$query_getPosts = "SELECT post_id, `place`, `number`, pagetext, title, updated FROM restaurant_sac ORDER BY restaurant_sac.`place`, restaurant_sac.`number`";
...
<title> Manage Salida a Celaya Listing</title>
<link href="../../styles/admin.css" rel="stylesheet" type="text/css" />
</head>

<body>
<h2> &nbsp; Manage Salida a Celaya Listing</h2>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_restaurant_sac.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#1E90FF"><B>Add Salida a Celaya Listing</a></B></font></a>
<P>&nbsp; &nbsp;<a href="manage_photo_event.php">Photo Events</a>
...
<td><a href="update_restaurant_sac.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_restaurant_sac.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
