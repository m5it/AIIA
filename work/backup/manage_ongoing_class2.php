...
$query_getPosts = "SELECT post_id, `date`, `time`, title, location, cost FROM sanmig_week_class ORDER BY sanmig_week_class.`location`, sanmig_week_class.`date`, sanmig_week_class.`time`";
...
<table width="1500" border="0">
  ...
  <?php do { ?>
    <tr>
      <td><?php echo $row_getPosts['location']; ?></td>
      ...
      <td><?php echo $row_getPosts['cost']; ?></td>
    </tr>
