...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO fooddrink_ads (`place`, `number`, photo, title, subtitle, date) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "manage_fooddrink_ads.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Add Food & Drink Ads</title>
