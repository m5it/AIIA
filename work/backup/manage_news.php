...
$query_getPosts = "SELECT post_id, `date`, `time`, code, title, updated FROM news WHERE news.`date`> '01-10-31' ORDER BY news.`date` DESC, news.`time` DESC";
...
<body>
<h2> &nbsp; Manage News</h2>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_news.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#1E90FF"><B>Add News</a></B></font></a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_onetime_event.php"><FONT FACE="TREBUCHET MS" SIZE="-1" COLOR="#000000"><B>Add Onetime Event</a></B></font></a>  <P>
&nbsp; &nbsp;<a href="manage_news.php">Photo Events</a>
...
<td><a href="update_news.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_news.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
