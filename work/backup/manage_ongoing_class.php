...
$query_getPosts = "SELECT post_id, `date`, `time`, title, updated FROM sanmig_week_class ORDER BY sanmig_week_class.`date`, sanmig_week_class.`time`";
...
<title>Regular (Ongoing/Weekly) Events Manage</title>
<link href="../../styles/admin.css" rel="stylesheet" type="text/css" />
</head>

<body>
<h2> &nbsp; Manage Regular (Ongoing/Weekly) Class</h2>
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_ongoing_class.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#004080"><B>Add Regular (Ongoing/Weekly) Class</a></B></font></a> <P>
...
&nbsp; &nbsp;<a href="manage_top-posts.php">Top Posts</a>
...
<table width="1000" border="0">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="update_ongoing_class.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_ongoing_class.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
