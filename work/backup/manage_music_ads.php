...
$query_getPosts = "SELECT post_id, `place`, `number`, photo, date FROM music_ads ORDER BY place, number";
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_music_ads.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#61B329"><B>Add a Music Ad</B></font></a> <P>
...
<tr>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="update_music_ads.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_music_ads.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
