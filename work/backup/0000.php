...
$query_getPosts = "SELECT post_id, `place`, `number`, photo, date FROM restaurant ORDER BY place, number";
...
<title>Manage Restaurant Listings</title>
<link href="../../styles/admin.css" rel="stylesheet" type="text/css" />
</head>

<body>
<h2> &nbsp; Manage Restaurant Listings</h2>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_restaurant.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#61B329"><B>Add a Restaurant Listing</B></font></a> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="manage_restaurant_ads.php">Restaurant Ads</a> <P>
...
<tr>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="update_restaurant.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_restaurant.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
