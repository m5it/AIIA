...
$query_getPosts = "SELECT post_id, `date`, `time`, code, title, updated FROM magazine  WHERE magazine.`date`> '01-10-31' ORDER BY magazine.`date` DESC, magazine.`time` ASC";
...
<title>Magazine Manage</title>
<link href="../../styles/admin.css" rel="stylesheet" type="text/css" />
</head>

<body>
<h2> &nbsp; Manage Magazine</h2>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_magazine.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#1E90FF"><B>Add Magazine Article</B></a></P></font><P>
...
<td><a href="update_magazine.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_magazine.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
