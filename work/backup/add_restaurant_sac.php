...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO restaurant_sac (`place`, `number`, photo, title, subtitle, pagetext) VALUES (%s, %s, %s, %s, %s, %s)",
...
<title>Add Salida a Celaya Listing</title>
...
<body>
<h1> &nbsp; Add Salida a Celaya Listing</h1>
...
<textarea name="photo" rows="10" id="description"></textarea>
    ...
    <label for="title">Salida a Celaya Listing Name:</label>
