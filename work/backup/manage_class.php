...
$query_getPosts = "SELECT post_id, `date`, `time`, title, updated FROM sanmig_class WHERE sanmig_class.`date`> '12-10-31' ORDER BY sanmig_class.`date` DESC, sanmig_class.`time` DESC";
...
<body>
<h2> &nbsp; Manage Class</h2>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_class.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#EE0000"><B>Add Class</a></B></font></a><P>
...
&nbsp; &nbsp; &nbsp;<a href="manage_magazine.php">Magazine</a></p></p>
<table width="1000" border="0">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="update_class.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_class.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
