...
$query_getPosts = "SELECT post_id, `place`, `number`, pagetext, title, updated FROM restaurant ORDER BY restaurant.`place`, restaurant.`number`";
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_restaurant.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#1E90FF"><B>Add Restaurant</a></B></font></a>
