...
$query_getPosts = "SELECT post_id, `place`, `number`, photo, title, date FROM restaurants_ads_sac ORDER BY place, number";
...
<title>Restaurant Ads Manage</title>
<link href="../../styles/admin.css" rel="stylesheet" type="text/css" />
</head>

<body>
<h2> &nbsp; Restaurants Manage Ads & Articles</h2>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_restaurant_ads_sac.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#61B329"><B>Add an Ad or Article</B></font></a> <P>
...
&nbsp; &nbsp;<a href="http://sanmigueldeallendeevents.com/zyxw4321/tours/manage_onetime_event.php">Tours</a>
</p>
...
<tr>
    ...
    <th scope="col">Ad / Photo - Title</th>
    <th scope="col">&nbsp;</th>
    <th scope="col">&nbsp;</th>
  </tr>
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_getPosts['photo']; ?><BR>
        <?php echo $row_getPosts['title']; ?></td>
      <td><a href="update_restaurant_ads_sac.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_restaurant_ads_sac.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
