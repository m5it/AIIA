...
$query_getPosts = "SELECT post_id, `date`, `time`, title, updated FROM sanmig_week ORDER BY sanmig_week.`date`, sanmig_week.`time`";
...
<body>
<h2> &nbsp; Manage Regular (Ongoing/Weekly) Events</h2>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_ongoing_event.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#B0171F"><B>Add Regular (Ongoing/Weekly) Event</a></B></font></a> <P>
...
<table width="1000" border="0">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="update_ongoing_event.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_ongoing_event.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
