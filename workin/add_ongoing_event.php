...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO sanmig_week (`date`, `time`, ending, star, type, title, location, contact, website, cost, coloron, coloroff, `description`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "manage_ongoing_event.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Add Regular (Ongoing) Event</title>
...
<body>
<h1> &nbsp; Add Regular (Ongoing/Weekly) Event</h1>
