...
$query_getPosts = "SELECT post_id, `date`, `time`, code, title, updated FROM photo_event WHERE photo_event.`date`> '01-10-31' ORDER BY photo_event.`updated` DESC, photo_event.`time` DESC";
