...
$query_getPosts = "SELECT post_id, `place`, `number`, photo, title, date FROM restaurants_ads ORDER BY place, number";
...
<h2> &nbsp; Restaurants Manage Ads & Articles</h2>
    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_restaurant_ads.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#61B329"><B>Add an Ad or Article</B></font></a> <P>
...
<tr>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="update_restaurant_ads.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_restaurant_ads.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
