...
$query_getPosts = "SELECT post_id, type, title, updated FROM galleries ORDER BY galleries.`type`, galleries.`title` ASC";
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_gallery.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#EE0000"><B>Add Gallery</a></B></font></a><P>
...
<table width="1000" border="0">
  ...
  <?php do { ?>
    <tr>
      ...
      <td><?php echo $row_getPosts['type']; ?></td>
      <td><?php echo $row_getPosts['title']; ?></td>
      <td><a href="update_gallery.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_gallery.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
