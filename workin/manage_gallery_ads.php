...
$query_getPosts = "SELECT post_id, `place`, `number`, photo, date FROM gallery_ads ORDER BY place, number";
...
<title>Gallery Ads Manage</title>
<link href="../../styles/admin.css" rel="stylesheet" type="text/css" />
</head>

<body>
<h2> &nbsp; Manage Gallery Ads</h2>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_gallery_ads.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#61B329"><B>Add a Gallery Ad</B></font></a> <P>
...
<tr>
  ...
  <?php do { ?>
    <tr>
      ...
      <td><a href="update_gallery_ads.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_gallery_ads.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
