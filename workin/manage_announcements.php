...
$query_getPosts = "SELECT post_id, `date`, `time`, code, title, updated FROM announcements WHERE announcements.`date`> '01-10-31' ORDER BY announcements.`date` DESC, announcements.`time` DESC";
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_announcements.php"><FONT FACE="TREBUCHET MS" SIZE="+2" COLOR="#1E90FF"><B>Add Announcement</a></B></font></a>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="add_onetime_event.php"><FONT FACE="TREBUCHET MS" SIZE="-1" COLOR="#000000"><B>Add Onetime Event</a></B></font></a>  <P>
...
<td><a href="update_announcements.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Edit</a></td>
      <td><a href="delete_announcements.php?post_id=<?php echo $row_getPosts['post_id']; ?>">Delete</a></td>
    </tr>
