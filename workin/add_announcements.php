...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO announcements (`date`, `time`, photo, title, subtitle, code) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "manage_announcements.php";
  if (isset($_SERVER['QUERY_STRING'])) {
