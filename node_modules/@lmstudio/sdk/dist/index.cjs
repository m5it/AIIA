...
const llmJinjaInputMessagesContentImagesConfigSchema = zod.z.discriminatedUnion("type", [
    zod.z.object({
        type: zod.z.literal("simple"),
        value: zod.z.string(),
    }),
    zod.z.object({
        type: zod.z.literal("numbered"),
        prefix: zod.z.string(),
        suffix: zod.z.string(),
    }),
    zod.z.object({
...
const llmJinjaInputMessagesContentConfigTextFieldNameSchema = zod.z.enum(["content", "text"]);
const llmJinjaInputMessagesContentConfigSchema = zod.z.discriminatedUnion("type", [
    zod.z.object({
...
const llmJinjaInputMessagesConfigSchema = zod.z.object({
    contentConfig: llmJinjaInputMessagesContentConfigSchema,
});
const llmJinjaInputConfigSchema = zod.z.object({
    messagesConfig: llmJinjaInputMessagesConfigSchema,
    useTools: zod.z.boolean(),
});
...
zod.z.discriminatedUnion("type", [functionToolSchema]);
/**
...
function tool({ name, description, parameters, implementation, }) {
    return {
        ...
        description,
        type: "function",
        parametersSchema: zod.z.object(parameters),
        implementation: implementation, // Erase types
    };
}
